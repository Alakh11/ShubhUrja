...
const ProjectGallery = () => {
  ...
  const projects = [
    ...
    { id: 2, title: "Farm Installation", location: "Sharda Nagar Lucknow", img: "./public/solar.jpeg" },
    { id: 3, title: "Commercial Plant", location: "Krishna Nagar Lucknow", img: "./public/bill.jpeg" },
